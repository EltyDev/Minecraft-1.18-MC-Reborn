...
public class CreativeScreen extends DisplayEffectsScreen<CreativeScreen.CreativeContainer> {
   ...
   protected void func_230450_a_(MatrixStack p_230450_1_, float p_230450_2_, int p_230450_3_, int p_230450_4_) {
      ...
      for(ItemGroup itemgroup1 : ItemGroup.GROUPS) {
         this.field_230706_i_.getTextureManager().bindTexture(CREATIVE_INVENTORY_TABS);
         if (itemgroup1.getIndex() != selectedTabIndex) {
            this.func_238808_a_(p_230450_1_, itemgroup1);
         }
      }

      this.field_230706_i_.getTextureManager().bindTexture(new ResourceLocation("textures/gui/container/creative_inventory/tab_" + itemgroup.getBackgroundImageName()));
