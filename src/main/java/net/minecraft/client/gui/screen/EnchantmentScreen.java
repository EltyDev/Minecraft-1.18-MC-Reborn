...
public class EnchantmentScreen extends ContainerScreen<EnchantmentContainer> {
   ...
   protected void func_230450_a_(MatrixStack p_230450_1_, float p_230450_2_, int p_230450_3_, int p_230450_4_) {
      ...
      for(int i1 = 0; i1 < 3; ++i1) {
         ...
         if (l1 == 0) {
            ...
            int j2 = 6839882;
            if ((l < i1 + 1 || this.field_230706_i_.player.experienceLevel < l1) && !this.field_230706_i_.player.abilities.isCreativeMode) {
               this.func_238474_b_(p_230450_1_, j1, j + 14 + 19 * i1, 0, 185, 108, 19);
   ...
   public void func_230430_a_(MatrixStack p_230430_1_, int p_230430_2_, int p_230430_3_, float p_230430_4_) {
      ...
      for(int j = 0; j < 3; ++j) {
         ...
         int i1 = j + 1;
         if (this.isPointInRegion(60, 14 + 19 * j, 108, 17, (double)p_230430_2_, (double)p_230430_3_) && k > 0 && l >= 0 && enchantment != null) {
            List<ITextComponent> list = Lists.newArrayList();
            list.add((new TranslationTextComponent("container.enchant.clue", enchantment.getDisplayName(l))).func_240699_a_(TextFormatting.WHITE));
            if (!flag) {
