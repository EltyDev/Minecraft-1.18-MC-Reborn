...
public abstract class ContainerScreen<T extends Container> extends Screen implements IHasContainer<T> {
   ...
   private void drawItemStack(ItemStack stack, int x, int y, String altText) {
      ...
      this.field_230707_j_.renderItemOverlayIntoGUI(this.field_230712_o_, stack, x, y - (this.draggedStack.isEmpty() ? 0 : 8), altText);
   ...
   public boolean func_231044_a_(double p_231044_1_, double p_231044_3_, int p_231044_5_) {
      if (super.func_231044_a_(p_231044_1_, p_231044_3_, p_231044_5_)) {
         ...
         boolean flag = this.field_230706_i_.gameSettings.keyBindPickBlock.matchesMouseKey(p_231044_5_);
            ...
            if (l != -1) {
               if (this.field_230706_i_.gameSettings.touchscreen) {
                  ...
                  if (this.field_230706_i_.player.inventory.getItemStack().isEmpty()) {
                     if (this.field_230706_i_.gameSettings.keyBindPickBlock.matchesMouseKey(p_231044_5_)) {
                     ...
                     } else if (this.field_230706_i_.gameSettings.keyBindPickBlock.matchesMouseKey(p_231044_5_)) {
   ...
   public boolean func_231048_c_(double p_231048_1_, double p_231048_3_, int p_231048_5_) {
      ...
      if (this.doubleClick && slot != null && p_231048_5_ == 0 && this.container.canMergeSlot(ItemStack.EMPTY, slot)) {
         if (func_231173_s_()) {
            if (!this.shiftClickedSlot.isEmpty()) {
               for(Slot slot2 : this.container.inventorySlots) {
                  if (slot2 != null && slot2.canTakeStack(this.field_230706_i_.player) && slot2.getHasStack() && slot2.inventory == slot.inventory && Container.canAddItemToSlot(slot2, this.shiftClickedSlot, true)) {
         ...
         if (this.clickedSlot != null && this.field_230706_i_.gameSettings.touchscreen) {
            ...
            if (this.field_230706_i_.gameSettings.keyBindPickBlock.matchesMouseKey(p_231048_5_)) {
   ...
   public boolean func_231046_a_(int p_231046_1_, int p_231046_2_, int p_231046_3_) {
      if (super.func_231046_a_(p_231046_1_, p_231046_2_, p_231046_3_)) {
         return true;
      } else if (this.field_230706_i_.gameSettings.keyBindInventory.matchesKey(p_231046_1_, p_231046_2_)) {
         this.func_231175_as__();
         return true;
      } else {
         this.func_195363_d(p_231046_1_, p_231046_2_);
         if (this.hoveredSlot != null && this.hoveredSlot.getHasStack()) {
            if (this.field_230706_i_.gameSettings.keyBindPickBlock.matchesKey(p_231046_1_, p_231046_2_)) {
               this.handleMouseClick(this.hoveredSlot, this.hoveredSlot.slotNumber, 0, ClickType.CLONE);
            } else if (this.field_230706_i_.gameSettings.keyBindDrop.matchesKey(p_231046_1_, p_231046_2_)) {
   ...
   protected boolean func_195363_d(int keyCode, int scanCode) {
      if (this.field_230706_i_.player.inventory.getItemStack().isEmpty() && this.hoveredSlot != null) {
         if (this.field_230706_i_.gameSettings.keyBindSwapHands.matchesKey(keyCode, scanCode)) {
            this.handleMouseClick(this.hoveredSlot, this.hoveredSlot.slotNumber, 40, ClickType.SWAP);
            return true;
         }

         for(int i = 0; i < 9; ++i) {
            if (this.field_230706_i_.gameSettings.keyBindsHotbar[i].matchesKey(keyCode, scanCode)) {
               this.handleMouseClick(this.hoveredSlot, this.hoveredSlot.slotNumber, i, ClickType.SWAP);
               return true;
            }
         }
