   ...
   protected List<String> getDebugInfoRight() {
      ...
      if (this.mc.isReducedDebug()) {
         ...
         if (this.rayTraceBlock.getType() == RayTraceResult.Type.BLOCK) {
            ...
            for(ResourceLocation resourcelocation : this.mc.getConnection().getTags().func_241835_a().getOwningTags(blockstate.getBlock())) {
         ...
         if (this.rayTraceFluid.getType() == RayTraceResult.Type.BLOCK) {
            ...
            for(ResourceLocation resourcelocation1 : this.mc.getConnection().getTags().func_241837_c().getOwningTags(fluidstate.getFluid())) {
