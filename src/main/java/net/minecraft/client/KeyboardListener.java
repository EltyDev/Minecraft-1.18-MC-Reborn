         ...
         if (inestedguieventhandler != null) {
            ...
            Screen.func_231153_a_(() -> {
               if (action != 1 && (action != 2 || !this.repeatEventsEnabled)) {
                  ...
                  aboolean[0] = inestedguieventhandler.func_231046_a_(key, scanCode, modifiers);
               }
