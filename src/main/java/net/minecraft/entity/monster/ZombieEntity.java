...
public class ZombieEntity extends MonsterEntity {
   ...
   public boolean attackEntityFrom(DamageSource source, float amount) {
      if (!super.attackEntityFrom(source, amount)) {
         ...
         if (livingentity != null && this.world.getDifficulty() == Difficulty.HARD && (double)this.rand.nextFloat() < this.func_233637_b_(Attributes.field_233829_l_) && this.world.getGameRules().getBoolean(GameRules.DO_MOB_SPAWNING)) {
   ...
   protected void func_230291_eT_() {
      this.getAttribute(Attributes.field_233829_l_).setBaseValue(this.rand.nextDouble() * (double)0.1F);
   }
