   ...
   public boolean func_241211_a_(BlockPos p_241211_1_, BlockState p_241211_2_, int p_241211_3_, int p_241211_4_) {
      if (isOutsideBuildHeight(p_241211_1_)) {
         ...
         if (blockstate == null) {
            ...
            if ((p_241211_3_ & 128) == 0 && blockstate1 != blockstate && (blockstate1.getOpacity(this, p_241211_1_) != blockstate.getOpacity(this, p_241211_1_) || blockstate1.getLightValue() != blockstate.getLightValue() || blockstate1.isTransparent() || blockstate.isTransparent())) {
